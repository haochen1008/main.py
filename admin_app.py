...
def get_conn():
    """
    最稳健的连接方式：不手动传参，让 Streamlit 自动寻找 secrets
    """
...
def create_poster(files, title_text):
    ...
    try:
        ...
        draw.text((50, 600), title_text, font=font_t, fill=(0, 0, 0))
        return canvas
    except: 
        return None
                ...
                try:
                    with st.spinner("正在发布并同步到表格..."):
                        ...
                        new_row = {
                            ...
                            "title": n_title, "region": n_reg, "price": n_price, 
