...
with tabs[1]:
    ...
    with col_s1:
        st.info("📍 **精准定向选址 (Bespoke Property Search)**
不仅是找房子，更是匹配生活方式。
• 覆盖城市： 深度覆盖伦敦 (London)、曼彻斯特 (Manchester)、伯明翰 (Birmingham) 等核心求学区域。
• 需求画像： 根据学生所在校区、预算偏好、安全系数及周边交通进行大数据筛选。")
        st.info("📝 **文书合规与风控 (Contract & Compliance)**
利用专业知识，在法律层面保护学生利益。
• 租房审查 (Reference) 协助： 针对留学生无英国担保人的痛点，提供专业的背景调查材料指导，大幅提高申请成功率。
• 合同细节审计： 深度解读 Tenancy Agreement，确保押金受 TDS 保护，规避租期中途断约、维修责任不清等霸王条款。
• 议价与谈判： 凭借行业经验与房东进行深度沟通，争取最优惠的租金或最灵活的租期条件。")
    with col_s2:
        st.info("👤 **账单管家 (Home Setting-up Support)**
解决落地英国后的“琐事焦虑。
• Utilities 托管： 协助开通及注册水、电、煤气 (Utility Bills) 账号，协助寻找性价比最高的宽带网络运营商。
• 政务处理： 指导学生申请 Council Tax 免税证明，节省每年的高额市政税开支。")
        st.info("🤝 **退租无忧 (Easy Check Out)**
消除后顾之忧。
• 设施检查 (Inventory)： 入住当天指导或协助进行房屋设施拍照存证，确保退房时押金能够全额退还。
• 疑难杂症咨询： 入住期间遭遇房屋漏水、设备损坏或与房东产生纠纷时，提供专业咨询与沟通支持。")
